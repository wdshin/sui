...
export function isSuiTransactionWithAuthSignersResponse(obj: any, _argumentName?: string): obj is SuiTransactionWithAuthSignersResponse {
    return (
        (obj !== null && typeof obj === "object") && isSuiTransactionResponse(obj.transaction_response) as boolean && Array.isArray(obj.signers) &&
        obj.signers.every((e: any) =>
            isAuthorityName(e) as boolean
        ))
}
